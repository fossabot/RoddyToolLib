...
class TimeUnit {
    ...
    boolean equals(o) {
        ...
        // Original string is not necessary! timeString is the normalized valued
        if (timeString != timeUnit.timeString) return false
    ...
    int hashCode() {
        int result
        result = (timeString != null ? timeString.hashCode() : 0)
        return result
    }
